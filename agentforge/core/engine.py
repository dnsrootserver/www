...
def _tool_notify(params, context):
    ...
    title = _render(params.get("title", "SkillSnap"), context)
    ...
    try:
        if method == "desktop":
            ...
            path = _render(params.get("path", "/tmp/skillsnap-notifications.log"), context)
...
class AgentEngine:
    ...
    def run_interactive(self):
        try:
            ...
            console = Console()
            console.print(Panel(
                f"[bold green]SkillSnap v1.1.0[/bold green]\n"
            ...
            print("SkillSnap v1.1.0 — Install 'rich' for interactive mode: pip install rich")
